...
function onCreatePost()
	...
	makeLuaText('shitTxt', 'André: 0', width, 22, 300+(23*4));
...
function onUpdatePost(elapsed)
	...
	setTextString('tnhTxt', 'Total de Notas: '..tnh);
	setTextString('sickTxt', 'Erik: '..sick);
	setTextString('goodTxt', 'Bom: '..good);
	setTextString('badTxt', 'Ruim: '..bad);
	setTextString('ShitsTxt', 'André: '..shit);
	setTextString('missesTxt', misses == 0 and 'Pro' or 'Erros: '..misses);
	if misses == 0 then
